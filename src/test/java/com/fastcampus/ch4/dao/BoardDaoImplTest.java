...
public class BoardDaoImplTest {
    ...
    @Test
    public void updateCommnetCnt() throws Exception{
        Integer bno = 1360;
        int cnt = 1;
        boardDao.updateCommentCnt(bno , cnt);
    }
    ...
    public void searchResultCnt() throws Exception {
        SearchCondition sc = new SearchCondition(1, 10, "asd", "T");
    ...
    @Test
    public void resultCnt() throws Exception {
        SearchCondition sc = new SearchCondition(1,10,"","");
        boardDao.searchResultCnt(sc);
        System.out.println(boardDao.searchResultCnt(sc));
    }
}