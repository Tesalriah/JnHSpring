...
//        log.info("주문 금액: " + totalPrice);
        ...
        parameters.put("approval_url", "https://jnh.kro.kr/mypage/order/pay/completed"); // 결제 성공 시 URL
        parameters.put("cancel_url", "https://jnh.kro.kr/mypage/order/pay/cancel");      // 결제 취소 시 URL
        parameters.put("fail_url", "https://jnh.kro.kr/mypage/order/pay/fail");          // 결제 실패 시 URL
