...
<div class="left_menu">
    ...
    <div><a <c:if test="${fn:contains(pageContext.request.requestURI, '/ask')}">style="color:#FFAEC9;"</c:if> <c:if test="${fn:contains(pageContext.request.requestURI, '/question')}">style="color:#FFAEC9;"</c:if>href="<c:url value="/admin/ask-mng"/>">문의관리</a></div>
