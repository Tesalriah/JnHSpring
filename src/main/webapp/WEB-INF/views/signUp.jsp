...
<div class="container">
    ...
    <script>
        msg = "${msg}";
        if(msg == "REG_ERR")alert("회원가입에 실패했습니다. 다시 시도해 주세요.")
    </script>
    <div class="user" modelAttribute="user">
        <form:form> <%--class="user" method="post" action="<c:url value="/signUp"/>"--%>
            ...
            <div class="input"><i class="fa-solid fa-mobile-screen"></i><input type="text" name="phone" value="${user.phone}" placeholder="휴대폰 번호" autocomplete="off"></div>
