...
<html lang="kr">
    <head>
        ...
        <script type="text/javascript" src="<c:url value='/resources/js/find-pwd.js'/>" defer></script>
                    ...
                    <form method="post" action="<c:url value="/find-pwd"/>">
                        <table class="info">
                            <tr>
                                ...
                                <td class="border_left"><input class="input_text" value="${id}" type="text" name="inputId"></td>
                            </tr>
