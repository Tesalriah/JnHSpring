                        ...
                        <c:forEach items="${list}" var="list">
                            <div class="reviews_each">
                                <div class="review_top">
                                    ...
                                    <div class="reviews_tools"><div class="edit_del" style="font-size: 14px;"><a href="<c:url value="/mypage/review/modify"/>?rno=${list.rno}">수정</a>|<form method="post" action="<c:url value="/mypage/review/remove"/>"><input name="rno" type="hidden" value="${list.rno}"> <button type="submit">삭제</button></form></div></div>
                                </div>
